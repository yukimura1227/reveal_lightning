...
window.addEventListener('DOMContentLoaded',function() {
  ...
  // TODO: このstrongの実装は、reveal_viewで利用しているstrongの実装と共通化したい。see: lib/js/override/reveal.js/plugin/markdown.js create_custom_renderer()
...
function compile_and_display_markdown() {
  ...
  let result_html = marked( input_markdown.replace(/:([A-Za-z].+?):/g, '<i class="em em-$1" style="font-size: 1em"></i>'));
