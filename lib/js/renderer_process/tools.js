      ...
      '<form class="vex-dialog-form">',
        '<div class ="vex-dialog-input">',
          '<div class="uk-grid">',
            ...
            '<div class="uk-width-1-2">',
              create_workspace_text_box_html().join(''),
            '</div>',
            '<div class="uk-width-1-4">',
...
function create_workspace_text_box_html() {
  var text_box_html = [
    '<input type="text" id="js-config-work-dir" list="workspace_list" value="' + settings.get('env.work_dir') + '" />',
    '<datalist id="workspace_list">',
      '<option value="北斗神拳">',
    　'<option value="南斗水鳥拳">',
    '</datalist>'
  ];
